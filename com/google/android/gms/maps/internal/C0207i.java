...
public interface C0207i extends IInterface {

    public static abstract class C1402a extends Binder implements C0207i {

        private static class C1401a implements C0207i {
        ...
        public static C0207i m1073F(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapLongClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0207i)) ? new C1401a(iBinder) : (C0207i) queryLocalInterface;
        }
