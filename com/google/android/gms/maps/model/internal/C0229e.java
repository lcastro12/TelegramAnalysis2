...
public interface C0229e extends IInterface {

    public static abstract class C1425a extends Binder implements C0229e {

        private static class C1424a implements C0229e {
            private IBinder f127a;

            C1424a(IBinder iBinder) {
                this.f127a = iBinder;
            }

            public boolean mo1553a(C0229e c0229e) throws RemoteException {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    obtain.writeStrongBinder(c0229e != null ? c0229e.asBinder() : null);
                    this.f127a.transact(19, obtain, obtain2, 0);
            ...
            public int hashCodeRemote() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    this.f127a.transact(20, obtain, obtain2, 0);
                    obtain2.readException();
                    int readInt = obtain2.readInt();
                    return readInt;
                } finally {
            ...
            public boolean isGeodesic() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    this.f127a.transact(18, obtain, obtain2, 0);
                    obtain2.readException();
                    if (obtain2.readInt() != 0) {
                        z = true;
                    }
            ...
            public void setGeodesic(boolean geodesic) throws RemoteException {
                ...
                try {
                    ...
                    obtain.writeInt(i);
                    this.f127a.transact(17, obtain, obtain2, 0);
                    obtain2.readException();
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static C0229e m1122R(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0229e)) ? new C1424a(iBinder) : (C0229e) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 19:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IPolygonDelegate");
                    isVisible = mo1553a(C1425a.m1122R(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
    ...
    boolean mo1553a(C0229e c0229e) throws RemoteException;
