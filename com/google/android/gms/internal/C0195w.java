...
public class C0195w<K, V> {
    ...
    L_0x0049:
        ...
        r3 = r4.m528c(r5, r1);	 Catch:{ all -> 0x0053 }
        r2 = r2 + r3;
    ...
    public final V put(K key, V value) {
        ...
        synchronized (this) {
            this.cd++;
            this.size += m528c(key, value);
            put = this.cb.put(key, value);
            if (put != null) {
                this.size -= m528c(key, put);
            }
        }
        if (put != null) {
    ...
    L_0x0043:
        ...
        r3 = r4.m528c(r1, r0);	 Catch:{ all -> 0x0032 }
        r2 = r2 - r3;
