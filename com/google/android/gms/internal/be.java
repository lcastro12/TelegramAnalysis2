...
public interface be extends IInterface {
    ...
    public static abstract class C1324a extends Binder implements be {

        private static class C1323a implements be {
            ...
            public void onAddGeofencesResult(int statusCode, String[] geofenceRequestIds) throws RemoteException {
                ...
                try {
                    ...
                    this.f79a.transact(1, obtain, obtain2, 0);
        ...
        public static be m851q(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof be)) ? new C1323a(iBinder) : (be) queryLocalInterface;
        }
