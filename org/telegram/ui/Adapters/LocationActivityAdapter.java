...
public class LocationActivityAdapter extends BaseLocationAdapter {
    ...
    private void updateCell() {
        ...
        if (this.customLocation != null) {
            this.sendLocationCell.setText(LocaleController.getString("SendSelectedLocation", C0553R.string.SendSelectedLocation), String.format(Locale.US, "(%f,%f)", new Object[]{Double.valueOf(this.customLocation.getLatitude()), Double.valueOf(this.customLocation.getLongitude())}));
        } else if (this.gpsLocation != null) {
            this.sendLocationCell.setText(LocaleController.getString("SendLocation", C0553R.string.SendLocation), LocaleController.formatString("AccurateTo", C0553R.string.AccurateTo, LocaleController.formatPluralString("Meters", (int) this.gpsLocation.getAccuracy())));
        } else {
            this.sendLocationCell.setText(LocaleController.getString("SendLocation", C0553R.string.SendLocation), LocaleController.getString("Loading", C0553R.string.Loading));
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (i == 0) {
            ...
            ((GreySectionCell) view).setText(LocaleController.getString("NearbyPlaces", C0553R.string.NearbyPlaces));
