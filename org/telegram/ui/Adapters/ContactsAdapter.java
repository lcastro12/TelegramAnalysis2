...
public class ContactsAdapter extends BaseSectionsAdapter {
    ...
    public View getItemView(int section, int position, View convertView, ViewGroup parent) {
        ...
        if (type == 4) {
            ...
            ((GreySectionCell) convertView).setText(LocaleController.getString("Contacts", C0553R.string.Contacts).toUpperCase());
            return convertView;
        } else if (type == 2) {
            if (convertView == null) {
            ...
            if (this.needPhonebook) {
                ...
                actionCell.setTextAndIcon(LocaleController.getString("InviteToGroupByLink", C0553R.string.InviteToGroupByLink), C0553R.drawable.menu_invite);
                return convertView;
            } else if (position == 0) {
            ...
            if (convertView == null) {
                convertView = new UserCell(this.mContext, 58, 1);
            ...
            if (this.checkedMap != null) {
                ...
                boolean z = !this.scrolling && VERSION.SDK_INT > 10;
