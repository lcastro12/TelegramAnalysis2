...
import com.google.android.gms.internal.C0177i;
import com.google.android.gms.internal.C0184m;
...
public final class GooglePlayServicesUtil {
    ...
    public static Intent m19a(Context context, int i, int i2) {
        switch (i) {
            case 1:
            case 2:
                return m25b(i2) ? m28c(context) ? C0184m.m490l(GOOGLE_PLAY_SERVICES_PACKAGE) : C0184m.m489k("com.google.android.apps.bazaar") : C0184m.m489k(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
                return C0184m.m487i(GOOGLE_PLAY_SERVICES_PACKAGE);
            default:
                return null;
        }
    }

    public static String m20a(Context context, int i) {
    ...
    public static boolean m21a(Resources resources) {
        return (as.an() && ((resources.getConfiguration().screenLayout & 15) > 3)) || m26b(resources);
    }

    private static byte[] m22a(PackageInfo packageInfo, byte[]... bArr) {
        try {
    ...
    private static byte[][] m23a(byte[][]... bArr) {
        int i = 0;
    ...
    public static String m24b(Context context, int i, int i2) {
        Resources resources = context.getResources();
        String string;
        switch (i) {
            case 1:
                string = m21a(context.getResources()) ? resources.getString(C0126R.string.common_google_play_services_install_text_tablet) : resources.getString(C0126R.string.common_google_play_services_install_text_phone);
                return m25b(i2) ? string + " (via Bazaar)" : string;
            case 2:
                string = resources.getString(C0126R.string.common_google_play_services_update_text);
                return m25b(i2) ? string + " (via Bazaar)" : string;
            case 3:
                return resources.getString(C0126R.string.common_google_play_services_enable_text);
            case 5:
                return resources.getString(C0126R.string.common_google_play_services_invalid_account_text);
            case 7:
                return resources.getString(C0126R.string.common_google_play_services_network_error_text);
            case 9:
                return resources.getString(C0126R.string.common_google_play_services_unsupported_text);
            default:
                return resources.getString(C0126R.string.common_google_play_services_unknown_issue);
        }
    }

    static boolean m25b(int i) {
        switch (m27c(i)) {
            case 0:
                return !m30g();
            case 1:
    ...
    private static boolean m26b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return as.ap() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    private static int m27c(int i) {
        return i == -1 ? 2 : i;
    }

    private static boolean m28c(Context context) {
        if (f18J) {
            return f20L;
        }
        try {
            return m22a(context.getPackageManager().getPackageInfo("com.google.android.apps.bazaar", 64), f17I) != null;
        } catch (NameNotFoundException e) {
            return false;
        }
    }

    private static byte[] m29c(String str) {
        try {
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(C0126R.string.common_google_play_services_unknown_issue);
        } catch (Throwable th) {
            Log.e("GooglePlayServicesUtil", "The Google Play services resources were not found. Check your project configuration to ensure that the resources are included.");
        }
        try {
            if (m22a(packageManager.getPackageInfo(GOOGLE_PLAY_STORE_PACKAGE, 64), f11C) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                return 9;
            }
            try {
                PackageInfo packageInfo = packageManager.getPackageInfo(GOOGLE_PLAY_SERVICES_PACKAGE, 64);
                if (m22a(packageInfo, r4) == null) {
