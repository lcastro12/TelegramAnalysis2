...
public interface C0206h extends IInterface {

    public static abstract class C1400a extends Binder implements C0206h {

        private static class C1399a implements C0206h {
        ...
        public static C0206h m1072E(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.IOnMapClickListener");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0206h)) ? new C1399a(iBinder) : (C0206h) queryLocalInterface;
        }
