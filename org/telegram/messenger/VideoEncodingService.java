...
public class VideoEncodingService extends Service implements NotificationCenterDelegate {
    ...
    public void onDestroy() {
        ...
        FileLog.m609e("tmessages", "destroy video service");
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (this.path == null) {
            ...
            FileLog.m609e("tmessages", "start video service");
            if (this.builder == null) {
                this.builder = new Builder(ApplicationLoader.applicationContext);
                this.builder.setSmallIcon(17301640);
                this.builder.setWhen(System.currentTimeMillis());
                this.builder.setContentTitle(LocaleController.getString("AppName", C0553R.string.AppName));
                this.builder.setTicker(LocaleController.getString("SendingVideo", C0553R.string.SendingVideo));
                this.builder.setContentText(LocaleController.getString("SendingVideo", C0553R.string.SendingVideo));
            }
