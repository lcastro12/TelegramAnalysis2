...
public class PhotoCropView extends FrameLayout {
    ...
    private float rectX = GroundOverlayOptions.NO_DIMENSION;
    private float rectY = GroundOverlayOptions.NO_DIMENSION;
    ...
    public void startAnimationRunnable() {
        if (this.animationRunnable == null) {
            this.animationRunnable = new C09341();
    ...
    public void animateToFill() {
        ...
        this.delegate.needMoveImageTo(((((float) (getWidth() / 2)) * (scaleTo - 1.0f)) + newX) + ((this.bitmapGlobalX - this.rectX) * scaleTo), ((((float) (getHeight() / 2)) * (scaleTo - 1.0f)) + newY) + ((this.bitmapGlobalY - this.rectY) * scaleTo), this.bitmapGlobalScale * scaleTo, true);
    }
