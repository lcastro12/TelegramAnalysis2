...
public class SecretPhotoViewer implements NotificationCenterDelegate {
    ...
    class C11901 implements OnTouchListener {
        C11901() {
        }
    ...
    private class SecretDeleteTimer extends FrameLayout {
        ...
        public SecretDeleteTimer(Context context) {
            ...
            this.drawable = getResources().getDrawable(C0553R.drawable.circle1);
        }
        ...
        protected void onDraw(Canvas canvas) {
            if (SecretPhotoViewer.this.currentMessageObject != null && SecretPhotoViewer.this.currentMessageObject.messageOwner.destroyTime != 0) {
                ...
                float progress = ((float) Math.max(0, (((long) SecretPhotoViewer.this.currentMessageObject.messageOwner.destroyTime) * 1000) - (System.currentTimeMillis() + ((long) (ConnectionsManager.getInstance().getTimeDifference() * LocationStatusCodes.GEOFENCE_NOT_AVAILABLE))))) / (((float) SecretPhotoViewer.this.currentMessageObject.messageOwner.ttl) * 1000.0f);
    ...
    public void setParentActivity(Activity activity) {
        if (this.parentActivity != activity) {
            ...
            this.containerView.setOnTouchListener(new C11901());
    ...
    public void closePhoto() {
        ...
        if (this.parentActivity != null) {
            ...
            AndroidUtilities.runOnUIThread(new C11912());
            try {
                if (this.windowView.getParent() != null) {
                    ((WindowManager) this.parentActivity.getSystemService("window")).removeView(this.windowView);
                }
