...
public class ContactsActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C09833 implements OnTouchListener {
        C09833() {
        }
    ...
    class C09854 implements OnItemClickListener {
        C09854() {
        }
                ...
                if ((ContactsActivity.this.onlyUsers && ContactsActivity.this.chat_id == 0) || section != 0) {
                    ...
                    if (item instanceof User) {
                        ...
                        if (usePhone != null && ContactsActivity.this.getParentActivity() != null) {
                            ...
                            builder.setMessage(LocaleController.getString("InviteUser", C0553R.string.InviteUser));
                            ...
                            builder.setPositiveButton(LocaleController.getString("OK", C0553R.string.OK), new OnClickListener() {
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    try {
                                        ...
                                        intent.putExtra("sms_body", LocaleController.getString("InviteText", C0553R.string.InviteText));
                    ...
                    if (row == 0) {
                        try {
                            ...
                            ContactsActivity.this.getParentActivity().startActivityForResult(Intent.createChooser(intent, LocaleController.getString("InviteFriends", C0553R.string.InviteFriends)), 500);
                        } catch (Throwable e) {
                            FileLog.m611e("tmessages", e);
                        }
                    }
    ...
    class C09865 implements OnScrollListener {
        C09865() {
        }
    ...
    class C15791 extends ActionBarMenuOnItemClick {
        C15791() {
        }
    ...
    class C15802 extends ActionBarMenuItemSearchListener {
        C15802() {
        }
        ...
        public void onSearchCollapse() {
            ...
            ContactsActivity.this.emptyTextView.setText(LocaleController.getString("NoContacts", C0553R.string.NoContacts));
        }
            ...
            if (ContactsActivity.this.searchListViewAdapter != null) {
                ...
                if (text.length() != 0) {
                    ...
                    if (ContactsActivity.this.emptyTextView != null) {
                        ContactsActivity.this.emptyTextView.setText(LocaleController.getString("NoResult", C0553R.string.NoResult));
                    }
                }
    ...
    public View createView(Context context) {
        ...
        if (!this.destroyAfterSelect) {
            this.actionBar.setTitle(LocaleController.getString("Contacts", C0553R.string.Contacts));
        } else if (this.returnAsResult) {
            this.actionBar.setTitle(LocaleController.getString("SelectContact", C0553R.string.SelectContact));
        } else if (this.createSecretChat) {
            this.actionBar.setTitle(LocaleController.getString("NewSecretChat", C0553R.string.NewSecretChat));
        } else {
            this.actionBar.setTitle(LocaleController.getString("NewMessageTitle", C0553R.string.NewMessageTitle));
        }
        this.actionBar.setActionBarMenuOnItemClick(new C15791());
        this.actionBar.createMenu().addItem(0, (int) C0553R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C15802()).getSearchField().setHint(LocaleController.getString("Search", C0553R.string.Search));
        ...
        emptyTextLayout.setOnTouchListener(new C09833());
        ...
        this.listView.setOnItemClickListener(new C09854());
        this.listView.setOnScrollListener(new C09865());
    ...
    private void didSelectResult(final User user, boolean useAlert, String param) {
        if (!useAlert || this.selectAlertString == null) {
            ...
            if (user.bot && user.bot_nochats) {
                try {
                    Toast.makeText(getParentActivity(), LocaleController.getString("BotCantJoinGroups", C0553R.string.BotCantJoinGroups), 0).show();
                    return;
                } catch (Throwable e) {
                    FileLog.m611e("tmessages", e);
                    return;
            ...
            if (!user.bot && this.needForwardCount) {
                message = String.format("%s\n\n%s", new Object[]{message, LocaleController.getString("AddToTheGroupForwardCount", C0553R.string.AddToTheGroupForwardCount)});
