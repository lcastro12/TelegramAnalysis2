...
public class SessionCell extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(widthMeasureSpec, MeasureSpec.makeMeasureSpec((this.needDivider ? 1 : 0) + AndroidUtilities.dp(90.0f), 1073741824));
    }
    ...
    public void setSession(TL_authorization session, boolean divider) {
        ...
        if ((session.flags & 2) == 0) {
            ...
            stringBuilder.append(LocaleController.getString("UnofficialApp", C0553R.string.UnofficialApp));
