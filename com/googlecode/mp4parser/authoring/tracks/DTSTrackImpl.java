...
public class DTSTrackImpl extends AbstractTrack {
    ...
    private boolean readVariables() throws IOException {
        ...
        if (testHeader1 == 1146377032 && testHeader2 == 1145586770) {
            ...
            if (this.isVBR) {
                this.ddts.setMaxBitRate((long) ((this.coreBitRate + this.extPeakBitrate) * LocationStatusCodes.GEOFENCE_NOT_AVAILABLE));
            } else {
                this.ddts.setMaxBitRate((long) ((this.coreBitRate + this.extAvgBitrate) * LocationStatusCodes.GEOFENCE_NOT_AVAILABLE));
            }
            this.ddts.setAvgBitRate((long) ((this.coreBitRate + this.extAvgBitrate) * LocationStatusCodes.GEOFENCE_NOT_AVAILABLE));
    ...
    private int getBitRate(int rate) throws IOException {
        switch (rate) {
            ...
            case 18:
                return 1152;
            case 19:
                return Strings.LOGIN_HEADLINE_TEXT_ID;
            case 20:
                return 1344;
            case 21:
                return 1408;
            ...
            case 23:
                return 1472;
            case 24:
                return Strings.PAINT_INDICATOR_TOAST_ID;
            case 25:
                return -1;
            default:
