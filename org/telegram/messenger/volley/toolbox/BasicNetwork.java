...
public class BasicNetwork implements Network {
    ...
    L_0x00fd:
        ...
        r7 = r27.getUrl();
        r4[r5] = r7;
        org.telegram.messenger.volley.VolleyLog.m614e(r3, r4);
    ...
    protected void logError(String what, String url, long start) {
        ...
        VolleyLog.m616v("HTTP ERROR(%s) %d ms to fetch %s", what, Long.valueOf(now - start), url);
    }
    ...
    private byte[] entityToBytes(HttpEntity entity) throws IOException, ServerError {
        ...
        try {
            ...
            try {
                ...
                VolleyLog.m616v("Error occured when calling consumingContent", new Object[0]);
            }
