...
public class Strings {
    ...
    public static final int ERROR_NO_NETWORK_MESSAGE_ID = 2304;
    ...
    static {
        ...
        DEFAULT.put(Integer.valueOf(2048), "OK");
        ...
        DEFAULT.put(Integer.valueOf(ERROR_NO_NETWORK_MESSAGE_ID), "Your device is not connected to the internet. Please resolve connectivity issues and try again.");
    }
    ...
    public static String get(StringListener listener, int resourceID) {
        ...
        if (result == null) {
            return (String) DEFAULT.get(Integer.valueOf(resourceID));
        }
        return result;
    }
}
