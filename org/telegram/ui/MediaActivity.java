...
import org.telegram.tgnet.TLRPC.TL_inputMessagesFilterAudioDocuments;
...
public class MediaActivity extends BaseFragment implements NotificationCenterDelegate, PhotoViewerProvider {
    ...
    class C11003 implements OnClickListener {
        C11003() {
        }
    ...
    class C11014 implements OnTouchListener {
        C11014() {
        }
    ...
    class C11025 implements OnItemClickListener {
        C11025() {
        }
    ...
    class C11036 implements OnScrollListener {
        C11036() {
        }
    ...
    class C11047 implements OnItemLongClickListener {
        C11047() {
        }

        public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long id) {
            if ((MediaActivity.this.selectedMode == 1 || MediaActivity.this.selectedMode == 4) && (view instanceof SharedDocumentCell)) {
                return MediaActivity.this.onItemLongClick(((SharedDocumentCell) view).getDocument(), view, 0);
            } else if (MediaActivity.this.selectedMode != 3 || !(view instanceof SharedLinkCell)) {
                return false;
            } else {
    ...
    class C11058 implements OnTouchListener {
        C11058() {
        }
    ...
    class C11069 implements OnPreDrawListener {
        C11069() {
        }
    ...
    class C16221 extends ActionBarMenuOnItemClick {
        ...
        class C16212 implements MessagesActivityDelegate {
            C16212() {
            }
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                ...
                if (VERSION.SDK_INT < 11 && MediaActivity.this.listView != null) {
                    MediaActivity.this.listView.setAdapter(null);
                    MediaActivity.this.listView = null;
                    MediaActivity.this.photoVideoAdapter = null;
                    MediaActivity.this.documentsAdapter = null;
                    MediaActivity.this.audioAdapter = null;
                    MediaActivity.this.linksAdapter = null;
                }
                ...
                if (MediaActivity.this.getParentActivity() != null) {
                    ...
                    builder.setMessage(LocaleController.formatString("AreYouSureDeleteMessages", C0553R.string.AreYouSureDeleteMessages, LocaleController.formatPluralString("items", MediaActivity.this.selectedFiles[0].size() + MediaActivity.this.selectedFiles[1].size())));
                    builder.setTitle(LocaleController.getString("AppName", C0553R.string.AppName));
                    builder.setPositiveButton(LocaleController.getString("OK", C0553R.string.OK), new C10991());
                ...
                fragment.setDelegate(new C16212());
                MediaActivity.this.presentFragment(fragment);
            }
        }
    }

    class C16232 extends ActionBarMenuItemSearchListener {
        C16232() {
        }
    ...
    public class MediaSearchAdapter extends BaseFragmentAdapter {
        ...
        class C16255 implements SharedLinkCellDelegate {
            C16255() {
            }
        ...
        public void queryServerSearch(String query, final int max_id, long did) {
            ...
            if (uid != 0) {
                ...
                if (this.currentType == 1) {
                    ...
                    req.filter = new TL_inputMessagesFilterAudioDocuments();
                }
                req.f142q = query;
            ...
            AndroidUtilities.runOnUIThread(new Runnable() {
                public void run() {
                    if (!MediaActivity.this.sharedMediaData[MediaSearchAdapter.this.currentType].messages.isEmpty()) {
                        ...
                        } else if (MediaSearchAdapter.this.currentType == 3 || MediaSearchAdapter.this.currentType == 4) {
                            ...
                            public void run() {
                                ...
                                for (int a = 0; a < copy.size(); a++) {
                                    ...
                                    for (String q : search) {
                                        ...
                                        if (name != null && name.length() != 0 && name.toLowerCase().contains(q)) {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (this.currentType == 1 || this.currentType == 4) {
                ...
                if (view == null) {
                    ...
                    ((SharedLinkCell) view).setDelegate(new C16255());
                }
    ...
    private class SharedLinksAdapter extends BaseSectionsAdapter {
        ...
        class C16261 implements SharedLinkCellDelegate {
            C16261() {
            }
        ...
        public View getItemView(int section, int position, View convertView, ViewGroup parent) {
            if (section < MediaActivity.this.sharedMediaData[3].sections.size()) {
                ...
                if (convertView == null) {
                    ...
                    ((SharedLinkCell) convertView).setDelegate(new C16261());
                }
    ...
    private class SharedPhotoVideoAdapter extends BaseSectionsAdapter {
        ...
        class C16271 implements SharedPhotoVideoCellDelegate {
            C16271() {
            }
    ...
    public View createView(Context context) {
        ...
        this.actionBar.setActionBarMenuOnItemClick(new C16221());
        for (a = 1; a >= 0; a--) {
        ...
        this.searchItem = menu.addItem(0, (int) C0553R.drawable.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new C16232());
        ...
        this.dropDownContainer.addSubItem(1, LocaleController.getString("SharedMediaTitle", C0553R.string.SharedMediaTitle), 0);
        this.dropDownContainer.addSubItem(2, LocaleController.getString("DocumentsTitle", C0553R.string.DocumentsTitle), 0);
        if (((int) this.dialog_id) != 0) {
            this.dropDownContainer.addSubItem(5, LocaleController.getString("LinksTitle", C0553R.string.LinksTitle), 0);
            this.dropDownContainer.addSubItem(6, LocaleController.getString("AudioTitle", C0553R.string.AudioTitle), 0);
        }
        ...
        this.dropDownContainer.setOnClickListener(new C11003());
        ...
        this.selectedMessagesCountTextView.setOnTouchListener(new C11014());
        actionMode.addView(this.selectedMessagesCountTextView, LayoutHelper.createLinear(0, -1, 1.0f, 65, 0, 0, 0));
        if (((int) this.dialog_id) != 0) {
            this.actionModeViews.add(actionMode.addItem(3, C0553R.drawable.ic_ab_fwd_forward, C0553R.drawable.bar_selector_mode, null, AndroidUtilities.dp(54.0f)));
        }
        this.actionModeViews.add(actionMode.addItem(4, C0553R.drawable.ic_ab_fwd_delete, C0553R.drawable.bar_selector_mode, null, AndroidUtilities.dp(54.0f)));
        ...
        this.listView.setOnItemClickListener(new C11025());
        this.listView.setOnScrollListener(new C11036());
        this.listView.setOnItemLongClickListener(new C11047());
        for (a = 0; a < 6; a++) {
        ...
        this.emptyView.setOnTouchListener(new C11058());
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (this.listView != null) {
            this.listView.getViewTreeObserver().addOnPreDrawListener(new C11069());
        }
    }
    ...
    private void switchToCurrentSelectedMode() {
        ...
        if (this.selectedMode == 0) {
            ...
            this.dropDown.setText(LocaleController.getString("SharedMediaTitle", C0553R.string.SharedMediaTitle));
            this.emptyImageView.setImageResource(C0553R.drawable.tip1);
            this.emptyTextView.setText(LocaleController.getString("NoMedia", C0553R.string.NoMedia));
            this.searchItem.setVisibility(8);
            ...
            if (this.selectedMode == 1) {
                ...
                this.dropDown.setText(LocaleController.getString("DocumentsTitle", C0553R.string.DocumentsTitle));
                this.emptyImageView.setImageResource(C0553R.drawable.tip2);
                this.emptyTextView.setText(LocaleController.getString("NoSharedFiles", C0553R.string.NoSharedFiles));
            } else if (this.selectedMode == 4) {
                this.listView.setAdapter(this.audioAdapter);
                this.dropDown.setText(LocaleController.getString("AudioTitle", C0553R.string.AudioTitle));
                this.emptyImageView.setImageResource(C0553R.drawable.tip4);
                this.emptyTextView.setText(LocaleController.getString("NoSharedAudio", C0553R.string.NoSharedAudio));
            }
            ...
            if (!(this.sharedMediaData[this.selectedMode].loading || this.sharedMediaData[this.selectedMode].endReached[0] || !this.sharedMediaData[this.selectedMode].messages.isEmpty())) {
                ...
                SharedMediaQuery.loadMedia(j, 0, 50, 0, i2, true, this.classGuid);
            }
            this.listView.setVisibility(0);
            if (this.sharedMediaData[this.selectedMode].loading && this.sharedMediaData[this.selectedMode].messages.isEmpty()) {
                this.progressView.setVisibility(0);
            ...
            this.dropDown.setText(LocaleController.getString("LinksTitle", C0553R.string.LinksTitle));
            this.emptyImageView.setImageResource(C0553R.drawable.tip3);
            this.emptyTextView.setText(LocaleController.getString("NoSharedLinks", C0553R.string.NoSharedLinks));
