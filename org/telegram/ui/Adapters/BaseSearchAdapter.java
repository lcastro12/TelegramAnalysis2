...
public class BaseSearchAdapter extends BaseFragmentAdapter {
    ...
    class C07262 implements Runnable {
        ...
        class C07241 implements Comparator<HashtagObject> {
            C07241() {
            }
        ...
        public void run() {
            try {
                ...
                cursor.dispose();
                Collections.sort(arrayList, new C07241());
    ...
    class C07284 implements Runnable {
        C07284() {
        }
    ...
    public void loadRecentHashtags() {
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new C07262());
    }
    ...
    public void clearRecentHashtags() {
        this.hashtags = new ArrayList();
        this.hashtagsByText = new HashMap();
        MessagesStorage.getInstance().getStorageQueue().postRunnable(new C07284());
    }
