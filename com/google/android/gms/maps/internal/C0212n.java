...
public interface C0212n extends IInterface {

    public static abstract class C1412a extends Binder implements C0212n {

        private static class C1411a implements C0212n {
        ...
        public static C0212n m1083L(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.internal.ISnapshotReadyCallback");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C0212n)) ? new C1411a(iBinder) : (C0212n) queryLocalInterface;
        }
