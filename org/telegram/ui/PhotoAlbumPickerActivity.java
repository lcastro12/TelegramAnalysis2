...
public class PhotoAlbumPickerActivity extends BaseFragment implements NotificationCenterDelegate {
    ...
    class C11323 implements OnTouchListener {
        C11323() {
        }
    ...
    class C11345 implements OnClickListener {
        C11345() {
        }
    ...
    class C11356 implements OnPreDrawListener {
        C11356() {
        }
        ...
        public void onItemClick(int id) {
            if (id == -1) {
                if (VERSION.SDK_INT < 11) {
                    PhotoAlbumPickerActivity.this.listView.setAdapter(null);
                    PhotoAlbumPickerActivity.this.listView = null;
                    PhotoAlbumPickerActivity.this.listAdapter = null;
                }
                PhotoAlbumPickerActivity.this.finishFragment();
            } else if (id == 1) {
                ...
                if (PhotoAlbumPickerActivity.this.selectedMode != 0) {
                    ...
                    PhotoAlbumPickerActivity.this.dropDown.setText(LocaleController.getString("PickerPhotos", C0553R.string.PickerPhotos));
                    PhotoAlbumPickerActivity.this.emptyView.setText(LocaleController.getString("NoPhotos", C0553R.string.NoPhotos));
                ...
                PhotoAlbumPickerActivity.this.dropDown.setText(LocaleController.getString("PickerVideo", C0553R.string.PickerVideo));
                PhotoAlbumPickerActivity.this.emptyView.setText(LocaleController.getString("NoVideo", C0553R.string.NoVideo));
                PhotoAlbumPickerActivity.this.listAdapter.notifyDataSetChanged();
            }
        }
    }

    class C16337 implements PhotoPickerActivityDelegate {
        C16337() {
        }
    ...
    private class ListAdapter extends BaseFragmentAdapter {
        ...
        class C16341 implements PhotoPickerAlbumsCellDelegate {
            C16341() {
            }
        ...
        class C16352 implements PhotoPickerSearchCellDelegate {
            C16352() {
            }
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (view == null) {
                    ...
                    photoPickerAlbumsCell.setDelegate(new C16341());
                } else {
                    photoPickerAlbumsCell = (PhotoPickerAlbumsCell) view;
                }
                ...
                view = new PhotoPickerSearchCell(this.mContext);
                ((PhotoPickerSearchCell) view).setDelegate(new C16352());
                return view;
            }
        }
    ...
    public View createView(Context context) {
        ...
        menu.addItem(1, (int) C0553R.drawable.ic_ab_other);
        this.fragmentView = new FrameLayout(context);
        FrameLayout frameLayout = this.fragmentView;
        frameLayout.setBackgroundColor(ViewCompat.MEASURED_STATE_MASK);
        if (this.singlePhoto) {
            this.actionBar.setTitle(LocaleController.getString("Gallery", C0553R.string.Gallery));
        } else {
            int dp;
            this.selectedMode = 0;
            this.dropDownContainer = new ActionBarMenuItem(context, menu, C0553R.drawable.bar_selector_picker);
            this.dropDownContainer.setSubMenuOpenSide(1);
            this.dropDownContainer.addSubItem(2, LocaleController.getString("PickerPhotos", C0553R.string.PickerPhotos), 0);
            this.dropDownContainer.addSubItem(3, LocaleController.getString("PickerVideo", C0553R.string.PickerVideo), 0);
            ...
            this.dropDownContainer.setOnClickListener(new C11312());
            ...
            this.dropDown.setText(LocaleController.getString("PickerPhotos", C0553R.string.PickerPhotos));
        ...
        this.emptyView.setOnTouchListener(new C11323());
        ...
        this.pickerBottomLayout.cancelButton.setOnClickListener(new C11334());
        this.pickerBottomLayout.doneButton.setOnClickListener(new C11345());
    ...
    private void fixLayout() {
        if (this.listView != null) {
            this.listView.getViewTreeObserver().addOnPreDrawListener(new C11356());
        }
    }
    ...
    private void openPhotoPicker(AlbumEntry albumEntry, int type) {
        ...
        fragment.setDelegate(new C16337());
