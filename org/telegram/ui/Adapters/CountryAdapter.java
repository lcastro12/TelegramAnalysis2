...
public class CountryAdapter extends BaseSectionsAdapter {
    ...
    class C07351 implements Comparator<String> {
        C07351() {
        }
    ...
    class C07362 implements Comparator<Country> {
        C07362() {
        }
    ...
    public CountryAdapter(Context context) {
        ...
        Collections.sort(this.sortedCountries, new C07351());
        for (ArrayList<Country> arr2 : this.countries.values()) {
            Collections.sort(arr2, new C07362());
        }
    }
